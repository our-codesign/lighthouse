      ...
      >
        <Wrapper containerIndex={0} id={ANCHORS.philosophy}>
          ...
          <CardContainer0>
            <DescriptionContainer0>
              ...
              foi desenvolvida sobre uma sólida base de conhecimentos. Sobre
              esta, um sofisticado sistema de orientação, fundamentado em
              algorítmos, permite aos investidores alcançarem seus objetivos de
              rentabilidade com simplicidade segurança.
            </DescriptionContainer0>
            <Button
              onClick={next}
              type="secondary"
        ...
        <Wrapper containerIndex={2}>
          ...
          <CardContainer2>
            ...
            <CardContainer2SubDescription>
              Projeção de cenários macro econômicos , onde fatores como inflação
              e crescimento são ponderados para antecipar as potenciais direções
              de mercado
            </CardContainer2SubDescription>
            <CardContainer2SubTitle>
        ...
        <Wrapper containerIndex={3}>
          ...
          <CardContainer3>
            ...
            <CardContainer3SubDescriptionWrapper>
              ...
              <CardContainer3SubDescription>
                O segundo capta os ciclos de volatilidade associadas a cada
                etapa estrutural do Mercado, projetando valores futuros
              </CardContainer3SubDescription>
              <CardContainer3SubDescription>
